...
| 32 | [Monthly restore verification](task-32-restore-verification.md) **[shared-philosophy]** | PARTIAL — `verify-restore` records durable evidence; scheduling and first live run remain (operator) | medium | low | yes |
